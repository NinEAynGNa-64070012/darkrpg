...
1.20.1-19: Added some new options to the default secondary pvp checker. Added glistering tool material, removing the now-obsolete line in items_Vx 'glisteringTridentDurability'
...
readme.altars.disenchant_2
 ...
 >> ignoreCurses: Boolean value, enter 'true' or 'false'.
...
Defines various base attributes of various mobs that are spawnable with AI.
 ...
 >> defaultSecondaryHitCheckerOption: Choose from the following options: [NONE, NON_BOSS, NON_VILLAGER, NON_GOLEM, NON_FRIENDLY, NON_FRIENDLY_NON_GOLEM, HOSTILE_ONLY, NON_BOSS_NON_FRIENDLY]
